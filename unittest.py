...
class TestBalanço(Balanço):
    def test_valor_total(self):
        ...
        self.assertEqual(self.get_valor_total("Ativo", ["1", "2"], ["10", "20"]), Decimal("30"))
        
    def test_calcular_patrimonio_liquido(self):
        # Testa se a função calcula_patrimonio_liquido retorna o valor correto
        ativos = Decimal("100")
        passivos = Decimal("50")
        self.assertEqual(self.calcula_patrimonio_liquido(ativos, passivos), Decimal("50"))
    ...
    def test_calcular_resultado_exercicio(self):
        ...
        self.assertEqual(self.calcula_resultado_exercicio(receitas, despesas), Decimal("100"))
